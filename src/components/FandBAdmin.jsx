...
const FandBAdmin = () => {
    ...
    const handleInputChange = (e) => {
        if (e.target.name == "itemaddcategory") {
            setItemAddCategory(e.target.value);
        }
        else if (e.target.name == "itemdeletecatagory") {
            setItemDeleteCategory(e.target.value);
        }
        else if (e.target.name == "itemcategorytoadd") {
                    ...
                    <div className='d-flex justify-content-between width-90percent reserv-col-gap-1 mt-4'>
                        <div className='col-md-6 flex-column border-full-blue border-radius-10 p-2'>
                            <div className="d-flex align-items-center flex-wrap">
                                ...
                                <div className="col-sm-8 medium-width-60percent">
                                    <input
                                        ...
                                        id="inputItemAddCategory"
                                        name="itemaddcategory"
                                        value={itemAddCategory}
                            ...
                            <div className="d-flex align-items-center justify-content-end mt-4 padding-right-40">
                                <button className="d-flex align-items-center justify-content-center width-150 font-size-16 text-primary btn button-color-onHover height-40 button-padding-5" onClick={(e) => { addCategory(e) }}>
                                    Add
                                </button>
                            </div>
                        </div>
                        <div className='col-md-6 flex-column border-full-blue border-radius-10 p-2'>
                            <div className="d-flex align-items-center flex-wrap">
                                ...
                                <div className="col-sm-8 medium-width-60percent">
                                    <select
                                        id="itemdeletecatagory"
                                        className="form-select font-size-14 background-gray"
                                        name="itemdeletecatagory"
                                        value={itemDeleteCategory}
                                        onChange={handleInputChange}
                                        required
                                    >
                                        <option value={""}> </option>
                            ...
                            <div className="d-flex align-items-center justify-content-end mt-4 padding-right-40">
                                <button className="d-flex align-items-center justify-content-center width-150 font-size-16 text-primary btn button-color-onHover height-40 button-padding-5" onClick={(e) => { deleteCategory(e) }}>
                                    Delete
                                </button>
                            </div>
                        </div>
