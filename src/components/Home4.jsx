            ...
            <div className="bg-skyblue min-height-vh">
                <div>
                    <div className="d-flex large-flex-column mx-5">
                        <div className="d-flex flex-column justify-content-center reserv-row-gap-point5 p-3 col-md-6 large-width-full">
                            <div>
                        ...
                        <div className="d-flex flex-column align-items-end justify-content-between p-4 col-md-6 large-width-full reserv-row-gap-2">
                            ...
                            <img src={SIT} alt="SIT" className="width-85perent height-450 border-radius-10" />
                        </div>
                    </div>
                    <p className="px-5 text-primary mt-4">© 2023 CSE Department <a href="https://www.sittechno.org/" target="_blank" rel="noreferrer" className="text-decoration-none text-hover-underline">Siliguri Institute of Technology</a>. All rights reserved.</p>
                </div>
            </div>
        </div>
    )
